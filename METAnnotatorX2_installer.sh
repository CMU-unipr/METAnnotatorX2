...
echo "Y" | sudo apt-get install default-jdk readseq gawk artemis emboss fastqc samtools cutadapt python
echo "Y" | sudo snap install curl
...
mkdir databases ;
cd databases ;
wget probiogenomics.unipr.it/sw/METAnnotatorX2/METAnnotatorX2_Diamond_RefSeq_database.zip ;
echo "Unzipping..."
unzip -q METAnnotatorX2_Diamond_RefSeq_database.zip ;
rm METAnnotatorX2_Diamond_RefSeq_database.zip ;
...
wget probiogenomics.unipr.it/sw/METAnnotatorX2/METAnnotatorX2_Diamond_functional_databases.zip ;
echo "Unzipping..."
unzip -q METAnnotatorX2_Diamond_functional_databases.zip ;
rm METAnnotatorX2_Diamond_functional_databases.zip ;
